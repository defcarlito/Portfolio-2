  ...
  return (
    <div className="relative" ref={tabsListRef}>
      <TabsPrimitive.List
        ...
        data-slot="tabs-list"
        className={cn(
          "bg-primary-foreground text-muted-foreground relative inline-flex h-9 w-fit items-center justify-center rounded-lg p-[3px]",
          className
        )}
        {...props}
      />
      <div
        className="absolute rounded-md border border-transparent bg-card shadow-sm dark:border-input dark:bg-input/30 transition-all duration-300 ease-in-out"
